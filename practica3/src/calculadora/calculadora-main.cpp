 ...
 * Modificado por: Yago Torres Garcia
...
/*
 * Pre:  ---
 * Post: Devuelve el factorial del número introducido, ejecutando la orden numero 6
 */
void ejecutarFactorial(int numero) {

    cout << "El número ";
    cout << factorial(numero);
    cout << " es factorial de ";
    cout << numero << endl;
...
/*
 * Pre:  Esta vez serán 2 numeros los introducidos
 * Post: Devolverá el mcd de los dos números, ejecutando la orden número 7
 */
void ejecutarMcd (int a, int b) {
...
/*
 * Pre:  Esta vez serán 2 numeros los introducidos
 * Post: Devolverá el mcm de los dos números, ejecutando la orden número 8
 */
void ejecutarMcm (int a, int b) {
...
/*
 * Pre:  --
 * Post: Devolverá si el número es capicua o no, ejecutando la orden número 9
 */
void ejecutarEsCapicua (int a) {
...
void ejecutarOrden(unsigned operacion) {
    if (operacion >= 1 && operacion <= NUM_OPERACIONES) {
        ...
        * En caso de que sea una de las dos operaciónes que requieren dos números,
        * pedirá otro.
        */
        ...
        // If's que eligen que función se ejecuta según el número elegido
